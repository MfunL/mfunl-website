...
<section class="trend-grid">
  <div class="wrap section-width">
    <h2 class="h-2 text-center">Evolving Trends in Healthcare Digital Marketing</h2>
    <h3 class="h-3 text-center">Stay ahead of the curve and improve your Google ranking</h3>

    <div class="trend-grid__grid">
      <?php foreach ($trends2026 as [$icon, $label]): ?>
